...
import { messageCreateHandler, messageDeleteHandler, messageReactionAddHandler, messageReactionRemoveAllHandler, messageReactionRemoveEmojiHandler, messageReactionRemoveHandler, messageUpdateHandler } from './discord/message';
...
client.on(Events.MessageReactionRemoveEmoji, messageReactionRemoveEmojiHandler);
client.on(Events.MessageReactionRemoveAll, messageReactionRemoveAllHandler);
