...
const help = `**?backup queue {nickname} {nicknames...}** Queue a backup player, removing them from spectator channels as if they were playing the game as usual. If adding multiple players, seperate nicknames with a space.
...
**?backup complete** Original player will be given spectator perms and be removed from dm.
    ...
    commands: [
        {
            ...
            arguments: {
                ...
                optional: Array(299).fill(z.string().min(1).max(100))
            }
        },
        {
            name: "lock",
